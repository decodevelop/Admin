        ...
        return back();
            ...
            /*
                Datos:
                    ...
                    $data[11]  =>   Cantidad enviada
                    $data[12]  =>   Cantidad aceptada
                    $data[13] => "Cantidad prevista"// restar 1 a partir
        ...
        if($resultado!=null){
          ...
          /*
              Datos:
                  ...
                  $data[8]  =>    Entrega desde
                  $data[9]  =>    Entrega hasta
                  $data[10]  =>   Cantidad enviada
                  $data[11]  =>   Cantidad aceptada
                  $data[13] => "Cantidad prevista" ???????? - restar 1 apartir de aquí
                  $data[14] => "Cantidad recibida"
                  $data[15] => "Cantidad restante"
                  $data[16] => "Coste por unidad"
                  $data[17] => "Coste total"
          */
          ...
          foreach ($pedidoAmazon as $j => $PO) {
            if(in_array($data[0],$PO)){
              $pedidoAmazon[$j]["cantidad_producto"]= $data[14] + $PO["cantidad_producto"];//antes 15
              $preu = explode(' ', $data[16]);// antes 17
