...
class Pedidos extends Model
{
     ...
     */
    protected $fillable = [
        'numero_pedido','numero_pedido_ps','referencia_ps','fecha_pedido','hora','total','precio_envio','observaciones','bultos','tasas','cupon','codigo_factura'
    ];
    protected $hidden = ['origen_id','id_cliente','id_metodo_pago'];
		 /**
