...
{$('.aButtons').append('<button value="ok">Aceptar</button>');$('.aButtons').append('<button value="cancel">Cancelar</button>');}
else if(args['verify'])
{$('.aButtons').append('<button value="ok">Si</button>');$('.aButtons').append('<button value="cancel">No</button>');}
else
