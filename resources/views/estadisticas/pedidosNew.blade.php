...
<section class="content">
	...
	<div class="row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="info-box">
            <span class="info-box-icon " style="border-left:10px solid {{$pedido->color}}" style=""><img src="{{$pedido->web}}/img/favicon.ico" alt="{{$pedido->referencia}}"></span>
              ...
              <ul class="products-list product-list-in-box">
                <li class="item">
                  <div class="product-img">
                    <img src="{{$pedido_dia_semana->web}}/img/favicon.ico" alt="{{$pedido_dia_semana->referencia}}">
                  </div>
