	...
	<!-- left column -->
		<div class="col-md-4 col-md-offset-0">
			<div class="box box-primary">
				<!-- /.box-header -->
				<!-- form start -->
				<form action="{{ url('importar_csv') }}" enctype="multipart/form-data" method="POST">
					{{ csrf_field() }}
					...
					<div class="box-body">
						...
						<div class="form-group">
								...
								<select class="form-control" name="o_csv">
									...
									<option value='CN'>Cabeceros (España,Francia,Portugal,Italia,Alemania)</option>
									<option value='DW'>Decowood.es</option>
									<option value="FS">Fox&Socks</option>
									<option value="FE">Fox&Socks (EUROPA)</option>
									<option value='CJ'>Cojines.es</option>
									<option value='CB' disabled>Cabeceros.com (Antigua)</option>
								</select>
								</div>
						</div>
						<div class="form-group">
