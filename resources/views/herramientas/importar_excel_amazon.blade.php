...
@section('titulo', 'Importar EXCEL amazon')
@section('titulo_h1', 'Importar EXCEL amazon')
			...
			<div class="box box-primary">
				...
				<form action="" enctype="multipart/form-data" method="POST">
					...
					<div class="box-header with-border">
						<h3 class="box-title">Importador de ficheros EXCEL amazon</h3>
					...
					@if ($repetidos = Session::get('amazonRepetidos'))
