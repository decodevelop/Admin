	...
	<!-- /.box-header -->
		...
		<form   id="modificar_pedido_form" action="{{Url('/pedidos/modificar/'.$detalles_pedido->id)}}" method="post">
			...
			<div class="col-sm-4 invoice-col">
				Datos Facturación
				<address>
				<strong><input type="text" class="form-control input-sm" name="cliente_facturacion" value="{{ $detalles_pedido->cliente_facturacion }}"/></strong><br>
				<input type="text" class="form-control input-sm" name="direccion_facturacion" value="{{ $detalles_pedido->direccion_facturacion }}"/><br>
			...
			<div class="col-sm-4 invoice-col">
				Datos envío
				<address>
				<strong><input type="text" class="form-control input-sm" name="cliente_envio" value="{{ $detalles_pedido->cliente_envio }}"/></strong><br>
				<input type="text" class="form-control input-sm" name="direccion_envio" value="{{ $detalles_pedido->direccion_envio }}"/><br>
				<input type="text" class="form-control input-sm" name="ciudad_envio" value="{{ $detalles_pedido->ciudad_envio }}"/> <input type="text" class="form-control input-sm" name="pais_envio" value="{{ $detalles_pedido->pais_envio }}"/> <input type="text" class="form-control input-sm" name="cp_envio" value="{{ $detalles_pedido->cp_envio }}"/><br>
			...
			<!-- /.col -->
			<div class="col-sm-4 invoice-col">
				<b>Factura Nº {{ $detalles_pedido->id }}</b><br>
				<br>
