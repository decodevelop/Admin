...
<ul class="sidebar-menu">
  ...
  <li class="treeview {{(Request::is('campanas*')) ? 'active':'' }}">
    ...
    <ul class="treeview-menu">
      ...
      <li class="{{(Request::is('campanas')) ? 'active':'' }}"><a href="{{url('/campanas/crear')}}"><i class="fa fa-plus "></i> Crear</a></li>
    </ul>
  </li>
  ...
  <li class="treeview {{(Request::is('proveedores*')) ? 'active':'' }}">
    ...
    <ul class="treeview-menu">
      <li class="{{(Request::is('proveedores')) ? 'active':'' }}"><a href="{{url('/proveedores')}}"><i class="fa fa-circle-o "></i> Inicio</a></li>
      <li class="{{(Request::is('proveedores')) ? 'active':'' }}"><a href="{{url('/proveedores/nuevo')}}"><i class="fa fa-plus "></i> Nuevo</a></li>
    </ul>
  </li>
