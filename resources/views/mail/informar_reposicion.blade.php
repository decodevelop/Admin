<html style="margin: 0;padding: 0;" xmlns="http://www.w3.org/1999/xhtml">
   ...
   <body class="mso">
    ...
    <body class="full-padding" style="margin: 0px; padding: 0px; text-size-adjust: 100%; height: auto; overflow-y: hidden;">
      ...
      <br/>
      <p>Se debe recoger {{$pedido['bultos']}} bulto/s en la siguiente dirección:</p>
      <br/>
      <p>{{$pedido['cliente_envio']}}</p>
      <p>{{$pedido['direccion_envio']}}, {{$pedido['ciudad_envio']}} , {{$pedido['cp_envio']}} </p>
      <p>{{$pedido['correo_comprador']}} {{$pedido['telefono_comprador']}}</p>
      <br/>
      <p>Y entregar en nuestra nave en LA ROCA DEL VALLES, 08430 , Carretera de la noria 13, Nave 3</p>
      <br/>
      <p>Muchas gracias,</p>
      <p>Un saludo.</p>
   </body>
