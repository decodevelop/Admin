              ...
              <tr class="filtro-admin">
                ...
                <th style="width: 10px">
                  <input name="o_csv" type="text" style="display:none">
                    ...
                    <option value="">Todos</option>
								...
								<th style="width: auto"><input class="form-control input-sm filterProducts" type="number" name="precio" placeholder="precio" step="any" value="{{@$_GET['precio']}}"></a>
</th>
                ...
                <td class="text-center">{{ (in_array('1',$estado_incidencia_p)) ? 'Abierta': 'Cerrada' }}</td>
                  ...
                  @if($pedidos->enviado == 0)
									  <td class="fecha-envio-{{ $pedidos->id }} text-center"><span class="label label-danger"><a href="#" onclick="return false" title="Transportista" data-toggle="popover" data-trigger="hover" data-content="{{$pedidos->metodo_entrega}}">no enviado</a></span></td>
                  @else
                  ...
                  <td class="text-center botones-pedidos" style="width: 12%;">
                    ...
                    <a title="Modificar" style="margin: 2px;"  href="/pedidos/modificar/{{$pedidos->id }}" type="button" class="btn btn-success btn-md modificar_pedido">  <i class="fa fa-edit"></i></a>
										...
										<a title="Duplicar" style="margin: 2px;"  href="/pedidos/duplicar/{{$pedidos->numero_pedido}}/{{$pedidos->o_csv}}" id="duplicar-pedido_{{ $pedidos->numero_pedido }}" type="button" class="btn btn-default btn-md"><i class="fa fa-files-o" aria-hidden="true"></i></a>
