              ...
              <tr class="filtro-admin">
                ...
                <th style="width: 10px">
                  <input name="o_csv" type="text" style="display:none">
                    ...
                    <option value="">Todos</option>
								...
								<th style="width: 250px"><input class="form-control input-sm filterProducts" type="text" name="nombre_producto" placeholder="nombre producto" value="{{@$_GET['nombre_producto']}}"></th>
								<th style="width: auto"><input class="form-control input-sm filterProducts" type="number" name="precio" placeholder="precio" step="any" value="{{@$_GET['precio']}}"></th>
								<th style="width: 10px"><input class="form-control input-sm filterProducts" type="text" name="correo_comprador" placeholder="Email" value="{{@$_GET['correo_comprador']}}">
                <input class="form-control input-sm filterProducts" type="text" name="telefono_comprador" placeholder="teléfono" value="{{@$_GET['telefono_comprador']}}"></th>
                ...
                ?>
                  ...
                  <?php $productos = explode(',',$pedidos->nombre_producto);
                      ...
                      <div class="@if($estado_incidencia_p[$key]!=0) incidencia @endif">
                        @if($estado_incidencia_p[$key]==1)
                          <i class="fa fa-exclamation-triangle" aria-hidden="true"></i>
                        @elseif($estado_incidencia_p[$key]==2)
                ...
                <td class="text-center">{{ (in_array('1',$estado_incidencia_p)) ? 'Abierta': 'Cerrada' }}</td>
                  ...
                  @if($pedidos->enviado == 0)
									  <td class="fecha-envio-{{ $pedidos->id }} text-center"><span class="label label-default"><a href="#" onclick="return false" title="Transportista" data-toggle="popover" data-trigger="hover" data-content="{{$pedidos->metodo_entrega}}">no enviado</a></span></td>
                  @elseif($pedidos->enviado == 2)
                    <td class="fecha-envio-{{ $pedidos->id }} text-center"><span class="label label-warning"><a href="#" onclick="return false" title="Transportista" data-toggle="popover" data-trigger="hover" data-content="{{$pedidos->metodo_entrega}}">+10 DÍAS</a></span></td>
                  @elseif($pedidos->enviado == 3)
                    <td class="fecha-envio-{{ $pedidos->id }} text-center"><span class="label label-danger"><a href="#" onclick="return false" title="Transportista" data-toggle="popover" data-trigger="hover" data-content="{{$pedidos->metodo_entrega}}">+20 DÍAS</a></span></td>
                  @elseif($pedidos->enviado == 4)
                    <td class="fecha-envio-{{ $pedidos->id }} text-center"><span class="label label-danger"><a href="#" onclick="return false" title="Transportista" data-toggle="popover" data-trigger="hover" data-content="{{$pedidos->metodo_entrega}}">+30 DÍAS</a></span></td>

                  @else
                    <td class="fecha-envio-{{ $pedidos->id }} text-center"><span class="label label-success"><a href="#" onclick="return false" title="Transportista" data-toggle="popover" data-trigger="hover" data-content="{{$pedidos->metodo_entrega}}">enviado</a></span></td>
                  @endif
                  ...
                  <div class="input-group" style="width: 130px;margin: auto;margin-top: 5px;">
                    ...
                    <div class="input-group-btn">
                      <button id="set-bultos_{{ $pedidos->id }}" class="btn btn-default" type="submit"><i class="fa fa-archive" aria-hidden="true"></i></button>
								...
								@else
									<td class=" text-center"><span class="label label-success "><a href="#" onclick="return false" title="Transportista" data-toggle="popover" data-trigger="hover" data-content="{{$pedidos->metodo_entrega}}">{{ $pedidos->fecha_envio }}</a></span></td>
									<td class="text-center botones-pedidos" style="width: 12%;">
										<button title="Aceptar envio" style="margin: 2px;" id="enviar-pedido_{{ $pedidos->id }}" type="button" class="btn btn-default btn-md"><i class="fa fa-truck" aria-hidden="true"></i></button>
										<a title="Ver detalles" style="margin: 2px;"  href="/pedidos/detalle/{{$pedidos->id }}" id="aceptar-{{ $pedidos->id }}" type="button" class="btn btn-default btn-md"><i class="fa fa-eye" aria-hidden="true"></i></a>
