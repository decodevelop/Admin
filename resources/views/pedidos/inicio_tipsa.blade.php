              ...
              <tr class="filtro-admin">
                ...
                <th style="width: 10px">
                  ...
                  <select class="form-control input-sm filterProducts" type="text" name="enviado">
                    ...
                    <option value="3" {{(@$_GET['enviado']=='3') ? 'selected': ''}}>RETRASO 15 DÍAS</option>
                ...
                <td class="text-center">{{ (in_array('1',$estado_incidencia_p)) ? 'Abierta': 'Cerrada' }}</td>
                    ...
                    <a title="Generar TIPSA" style="margin: 2px;"  id="boton-mrw_{{$pedidos->id}}" type="button" class="btn btn-default btn-md btn-mrw"><img src="/img/pedidos/tipsa.png" alt="tipsa" style="width: 60px;"></a>
                  </td>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <form id="form-mrw" action="" method="post">
          <div class="modal-header">
            <div class="col-md-4">
              <img src="/img/pedidos/tipsa.png" alt="tipsa">
            </div>
            <div class="col-md-5">
...
$(document).ready(function(){
  ...
  $('[id^="boton-mrw_"]').click(function(){
    var idped = $( this ).attr("id").split("_")[1];
      ...
      $('.loader-dw').show();
		$.ajax({
			url: "/pedidos/tipsa/csv/"+idped+"/false",
			method: "GET",
      ...
      var a_csv = JSON.parse(pedido);
       ...
       $('#form-mrw').attr('action',"/pedidos/tipsa/csv/"+idped);
