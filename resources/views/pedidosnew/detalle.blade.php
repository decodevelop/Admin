		...
		<div class="row invoice-info">
			<div class="col-sm-4 invoice-col">
				...
				<address>
					...
					@if(is_null($pedido->direccion))
						{{ $pedido->cliente->direcciones[0]->direccion_facturacion }}<br>
						{{ $pedido->cliente->direcciones[0]->ciudad_facturacion }}, {{ $pedido->cliente->direcciones[0]->pais_facturacion }} {{ $pedido->cliente->direcciones[0]->cp_facturacion }}<br>
					@else
						{{ $pedido->direccion->direccion_facturacion }}<br>
						{{ $pedido->direccion->ciudad_facturacion }}, {{ $pedido->direccion->pais_facturacion }} {{ $pedido->direccion->cp_facturacion }}<br>
					@endif
			...
			<div class="col-sm-4 invoice-col">
				...
				<address>
					...
					@if(is_null($pedido->direccion))
						{{ $pedido->cliente->direcciones[0]->direccion_envio }}<br>
						{{ $pedido->cliente->direcciones[0]->ciudad_envio }}, {{ $pedido->cliente->direcciones[0]->pais_envio }} {{ $pedido->cliente->direcciones[0]->cp_envio }}<br>
					@else
						{{ $pedido->direccion->direccion_envio }}<br>
						{{ $pedido->direccion->ciudad_envio }}, {{ $pedido->direccion->pais_envio }} {{ $pedido->direccion->cp_envio }}<br>
					@endif
