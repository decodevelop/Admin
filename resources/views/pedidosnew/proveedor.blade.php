                ...
                @forelse($listado_pedidos as $pedido)
                  ...
                  <tr class="ver_pedido num-{{ $pedido->id }}">
                    ...
                    @if($pedido->observaciones)
                      <td>
                        <a href="#" onclick="return false" title="Observaciones" data-toggle="popover" data-trigger="hover" data-content="{{$pedido->observaciones}}">
                          <div>
                            @if(is_null($pedido->direccion))
                              {{ $pedido->cliente->direcciones[0]->pais_envio.' - '.$pedido->cliente->direcciones[0]->ciudad_envio.' - '.$pedido->cliente->direcciones[0]->direccion_envio }}
                            @else
                              {{ $pedido->direccion->pais_envio.' - '.$pedido->direccion->ciudad_envio.' - '.$pedido->direccion->direccion_envio }}
                            @endif
                          </div>
                        </a>
                      </td>
