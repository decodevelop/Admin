...
@section('titulo','Modificando Personal '.$personal->id)
    ...
    <div class="row">
      <div class="col-xs-12">
        <h2 class="page-header">
          <i class="fa fa-tags"></i>&nbsp; Modificando Personal {{$personal->id}} de {{$proveedor->nombre}}<small class="pull-right"></small>
        </h2>
      </div>
    </div>
    <div class="row">
                ...
                <div class="col-sm-12">
                  <table class="table">
                    <tbody>
                      <tr>
                        <td>Cargo:</td>
                        <td><input name="pers_cargo" type="text" class="form-control"  value="{{$personal->cargo}}" @if($personal->cargo == 'Contabilidad' || $personal->cargo == 'Comercial' || $personal->cargo == 'Pedidos') readonly @endif></td>
                      </tr>
                      <tr>
                        <td>Nombre:</td>
                        <td><input name="pers_nombre" type="text" class="form-control"  value="{{$personal->nombre}}"></td>
                      </tr>
                      <tr>
                        <td>Correo:</td>
                        <td><input name="pers_correo" data-type="text" class="form-control" value="{{$personal->correo}}"></td>
                      </tr>
                      <tr>
                        <td>Teléfono:</td>
                        <td><input name="pers_telefono" data-type="number" class="form-control" value="{{$personal->telefono}}"></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
