...
@section('titulo','Editando ('.$transportista->nombre.")")
		...
		<div class="row">
			<div class="col-xs-12">
				<h2 class="page-header">
					<i class="fa fa-globe"></i>&nbsp; Modificando {{$transportista->id}}. {{$transportista->nombre}}<small class="pull-right"></small>
				</h2>
			</div>
		</div>
		<!-- /.box-header -->
		...
		<div class="row invoice-info">
			<form id="crear_nuevo_transportista_form" action="" method="post">
				...
				<div class="col-sm-3 invoice-col">
					...
					Transportista: <input type="text" class="form-control input-sm form-margin" name="nombre" value="@if(isset($transportista)){{$transportista->nombre}}@endif"/>
