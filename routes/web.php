...
Route::group(['middleware' => 'auth'], function() {
	...
	Route::get('/clientes/{id_proveedor}/direcciones/modificar/{id_direccion}', 'ClientesController@modificar_direccion');
	Route::post('/clientes/{id_proveedor}/direcciones/modificar/{id_direccion}', 'ClientesController@modificar_direccion_POST');
